                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#"
                               className="text-sm font-medium text-gray-500 hover:text-gray-600 hover:underline dark:text-primary-500">Forgot
                                password?</a>
                        </div>
                        <div id="btnSignIn" onClick={handleClick}
                             className="w-full text-white bg-blue-600 hover:bg-blue-700
                                ...
                                text-center dark:bg-primary-600 dark:hover:bg-primary-700
                                 dark:focus:ring-primary-800 cursor-pointer"> Sign in
                        </div>
